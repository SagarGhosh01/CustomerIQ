  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-50 dark:bg-slate-950 px-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-md glass-panel rounded-2xl border border-slate-200 dark:border-slate-800 p-8 z-10 shadow-2xl relative animate-slide-up">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-lg bg-rose-500/10 border border-rose-500/35 text-rose-600 dark:text-rose-200 text-sm">
            {error}
          </div>
        )}
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-slate-50 dark:bg-slate-950 px-3 text-slate-500 dark:text-slate-400 font-medium transition-colors">Demo Access</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-white hover:bg-slate-100 border border-slate-200 dark:bg-slate-900 dark:hover:bg-slate-850 dark:border-slate-800 rounded-lg py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-300 transition-all shadow-sm"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-white hover:bg-slate-100 border border-slate-200 dark:bg-slate-900 dark:hover:bg-slate-850 dark:border-slate-800 rounded-lg py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-300 transition-all shadow-sm"
          >
            <UserCheck className="text-violet-555 dark:text-violet-500" size={14} />
            Employee Demo
          </button>
        </div>
      </div>
